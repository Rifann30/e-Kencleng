    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'larapex-chart' => \ArielMejiaDev\LarapexCharts\LarapexChart::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\kencleng-masjid\public\storage' => 'string',
            'larapex-charts.colors' => 'array',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\kencleng-masjid\\public\\storage',
'larapex-charts.colors','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.queries.explain','sanctum.csrf-cookie','logout-user',
'dashboard','cetakSaldo','login','register','userprofil.index','userprofil.create','userprofil.store','userprofil.show',
'userprofil.edit','userprofil.update','userprofil.destroy','pengeluaran.index','pengeluaran.create',
'pengeluaran.store','pengeluaran.show','pengeluaran.edit','pengeluaran.update','pengeluaran.destroy',
'pengeluaran.cetak','pengambilan.index','pengambilan.create','pengambilan.store','pengambilan.show',
'pengambilan.edit','pengambilan.update','pengambilan.destroy','pengambilan.temp.toggle','pengambilan.temp.clear',
'home','jamaah.index','jamaah.create','jamaah.store','jamaah.show',
'jamaah.edit','jamaah.update','jamaah.destroy','jamaah.cetak','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','cetakSaldo','dashboard','home','jamaah',
'larapex-charts::chart.container','larapex-charts::chart.script','layouts.app','layouts.app_adminkit','layouts.app_welcome',
'pages.jamaah.cetak','pages.jamaah.create','pages.jamaah.edit','pages.pengambilan.edit','pages.pengambilan.show',
'pages.pengeluaran.cetak','pages.pengeluaran.create','pages.pengeluaran.edit','pages.pengeluaran.show','pages.userprofil.create',
'pages.userprofil.edit','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'pengambilan','pengeluaran','userprofil','vendor.larapex-charts.chart.container','vendor.larapex-charts.chart.script',
...
'vendor.pagination.simple-bootstrap-5','vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','welcome',
'flash::message','flash::modal','larapex-charts::chart.container','larapex-charts::chart.script','laravel-exceptions-renderer::components.card',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.attributes.address',
'validation.attributes.affiliate_url','validation.attributes.age','validation.attributes.amount','validation.attributes.announcement','validation.attributes.area',
'validation.attributes.audience_prize','validation.attributes.audience_winner','validation.attributes.available','validation.attributes.birthday','validation.attributes.body',
'validation.attributes.city','validation.attributes.company','validation.attributes.compilation','validation.attributes.concept','validation.attributes.conditions',
'validation.attributes.content','validation.attributes.contest','validation.attributes.country','validation.attributes.cover','validation.attributes.created_at',
'validation.attributes.creator','validation.attributes.currency','validation.attributes.current_password','validation.attributes.customer','validation.attributes.date',
'validation.attributes.date_of_birth','validation.attributes.dates','validation.attributes.day','validation.attributes.deleted_at','validation.attributes.description',
'validation.attributes.display_type','validation.attributes.district','validation.attributes.duration','validation.attributes.email','validation.attributes.excerpt',
'validation.attributes.filter','validation.attributes.finished_at','validation.attributes.first_name','validation.attributes.gender','validation.attributes.grand_prize',
'validation.attributes.group','validation.attributes.hour','validation.attributes.image','validation.attributes.image_desktop','validation.attributes.image_main',
'validation.attributes.image_mobile','validation.attributes.images','validation.attributes.is_audience_winner','validation.attributes.is_hidden','validation.attributes.is_subscribed',
'validation.attributes.is_visible','validation.attributes.is_winner','validation.attributes.items','validation.attributes.key','validation.attributes.last_name',
'validation.attributes.lesson','validation.attributes.line_address_1','validation.attributes.line_address_2','validation.attributes.login','validation.attributes.message',
...
'validation.attributes.photo','validation.attributes.portfolio','validation.attributes.postal_code','validation.attributes.preview','validation.attributes.price',
'validation.attributes.product_id','validation.attributes.product_uid','validation.attributes.product_uuid','validation.attributes.promo_code','validation.attributes.province',
'validation.attributes.quantity','validation.attributes.reason','validation.attributes.recaptcha_response_field','validation.attributes.referee','validation.attributes.referees',
...
'validation.attributes.value','validation.attributes.winner','validation.attributes.work','validation.attributes.year','en.0',
...
'http-statuses.599','http-statuses.unknownError','id.0',);
